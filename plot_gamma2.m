...
Rsort(12) = []; Rsort(18) = [];
gammasort(12) = []; gammasort(18) = [];

FE_array = zeros(1,length(gammasort));
...
figure(1)
set(gcf, 'Units', 'Inches', 'Position', [0, 0, 6, 5], 'PaperUnits', 'Inches', 'PaperSize', [6, 5])
...
set(gca, 'Fontsize', 28)
saveas(gcf,'analysis-1V2.png')
savefig('analysis-1V2.fig')
...
box on
saveas(gcf,'analysis-1-insetV2.png')
saveas(gcf,'analysis-1-insetV2.fig') 


conv_factor = 1.38*298/100;
figure(2)
set(gcf, 'Units', 'Inches', 'Position', [0, 0, 6.5 5], 'PaperUnits', 'Inches', 'PaperSize', [6.5, 5])
...
set(gca, 'linewidth',2)
set(gca, 'Fontsize', 28)
saveas(gcf,'analysis-2V2.png')
saveas(gcf,'analysis-2V2.fig')
%}
