function [] = jenkins_solve1(R_sol, w_sol, p_sol)
    kappa = 80;
    %figure
    %axis equal;
    %hold on
    solinit = bvpinit(linspace(0, pi, 2000), @guess);
    ...
    % save data
    fName = ['ms_plot_shapes2/p_' num2str(p_sol) '_w_' num2str(w_sol) '_R' num2str(round(R_sol)) '.mat'];
