function [] = jenkins_ms2(real_w, real_pressure, R_set)
    ...
    for k = 1:4
        for i = 1:300
            fName = ['omega/refine',num2str(real_pressure),'/try',num2str(k),'_p_',num2str(real_pressure),'_w_',num2str(real_w),'_',num2str(i),'.mat'];
            if exist(fName)
    ...
    % save data
    fName = ['ms_plot_omega/p_' num2str(real_pressure) '_w_' num2str(real_w) '_R' num2str(round(R_set)) '.mat'];
